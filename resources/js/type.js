!function (t, s) {
    ...
    var s = {strings: ["These are the default values...", "You know what you should do?", "Use your own!", "Have a great day!"], stringsElement: null, typeSpeed: 0, startDelay: 0, backSpeed: 0, smartBackspace: true, shuffle: false, backDelay: 700, fadeOut: false, fadeOutClass: "typed-fade-out", fadeOutDelay: 500, loop: false, loopCount: Infinity, showCursor: true, cursorChar: "|", autoInsertCss: true, attr: null, bindInputFocusEvents: false, contentType: "html", onBegin: function (t) {}, onComplete: function (t) {}, preStringTyped: function (t, s) {}, onStringTyped: function (t, s) {}, onLastStringBackspaced: function (t) {}, onTypingPaused: function (t, s) {}, onTypingResumed: function (t, s) {}, onReset: function (t) {}, onStop: function (t, s) {}, onStart: function (t, s) {}, onDestroy: function (t) {}}, e = new (function () {
      ...
      return n.load = function (e, n, i) {
        ...
        e.arrayPos = 0, e.stopNum = 0, e.loop = e.options.loop, e.loopCount = e.options.loopCount, e.curLoop = 0, e.shuffle = e.options.shuffle, e.pause = {status: false, typewrite: true, curString: "", curStrPos: 0}, e.typingComplete = false, e.autoInsertCss = e.options.autoInsertCss, e.autoInsertCss && (this.appendCursorAnimationCss(e), this.appendFadeOutAnimationCss(e));
    ...
    return function () {
      ...
      return s.toggle = function () {
        ...
        void 0 === t && (t = true), clearInterval(this.timeout), this.replaceText(""), this.cursor && this.cursor.parentNode && (this.cursor.parentNode.removeChild(this.cursor), this.cursor = null), this.strPos = 0, this.arrayPos = 0, this.curLoop = 0, t && (this.insertCursor(), this.options.onReset(this), this.begin());
      }, s.begin = function () {
        var t = this;
        ...
        true !== this.pause.status ? this.timeout = setTimeout(function () {
          ...
          if ("^" === o.charAt(0) && /^\^\d+/.test(o)) {
            var a = 1;
            a += (o = /\d+/.exec(o)[0]).length, i = parseInt(o), e.temporaryPause = true, e.options.onTypingPaused(e.arrayPos, e), t = t.substring(0, s) + t.substring(s + a), e.toggleBlinking(true);
          }
          if ("`" === o.charAt(0)) {
          ...
          e.timeout = setTimeout(function () {
            e.toggleBlinking(false), s >= t.length ? e.doneTyping(t, s) : e.keepTyping(t, s, r), e.temporaryPause && (e.temporaryPause = false, e.options.onTypingResumed(e.arrayPos, e));
          }, i);
        }, i) : this.setPauseStatus(t, s, true);
      }, s.keepTyping = function (t, s, e) {
        0 === s && (this.toggleBlinking(false), this.options.preStringTyped(this.arrayPos, this));
        ...
        } else this.setPauseStatus(t, s, false);
      }, s.complete = function () {
